...
public class MyPianiReader implements PianiReader {
	...
	public List<PianoDiStudi> caricaPianiDiStudi(
			Map<Long, Insegnamento> mappaInsegnamenti)
	...
	private PianoDiStudi leggiPianiDiStudi(
			Map<Long, Insegnamento> mappaInsegnamenti)
			throws MalformedFileException, IOException {
		try {
			...
			if (!token.equals("STUDENTE"))
				throw new MalformedFileException(
						"Errore nel formato del file Carriere: manca 'STUDENTE'");
			...
			if (!token.equals("PIANO DI STUDI"))
				throw new MalformedFileException(
						"Errore nel formato del file Carriere: manca 'PIANO DI STUDI'");
